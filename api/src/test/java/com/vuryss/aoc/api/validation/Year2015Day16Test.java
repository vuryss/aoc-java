...
@QuarkusTest
class Year2015Day16Test extends BaseValidatorTest {
    @Override
    ...
    static Stream<Arguments> validInputData() {
        return Stream.of(
            Arguments.of(
                ...
                Sue 3: children: 3, samoyeds: 2, cars: 2
                """,
                new Answer("3", "3")
            ),
            Arguments.of(
    ...
    static Stream<Arguments> invalidInputData() {
        return Stream.of(
            ...
            Arguments.of("\n"),
            Arguments.of("abc"),
            Arguments.of("Sue 1 goldfish: 9, cars: 0, samoyeds: 9"), // Missing colon after number
            Arguments.of("sue 1: goldfish: 9, cars: 0, samoyeds: 9"), // Lowercase Sue
            Arguments.of("Sue: goldfish: 9, cars: 0, samoyeds: 9"), // Missing number
            Arguments.of("Sue 1: goldfish 9, cars: 0, samoyeds: 9"), // Missing colon after property
            Arguments.of("Sue 1: goldfish: 9 cars: 0 samoyeds: 9"), // Missing commas
            Arguments.of("Sue 1: goldfish: 9, cars: 0"), // Only 2 properties
            Arguments.of("Sue 1: goldfish: 9, cars: 0, samoyeds: 9, trees: 3"), // 4 properties
            Arguments.of("Sue 1: Goldfish: 9, cars: 0, samoyeds: 9"), // Uppercase property
            Arguments.of("Sue 1: goldfish: abc, cars: 0, samoyeds: 9"), // Non-numeric value
            Arguments.of("a".repeat(50001)) // Too long
        );
    }
}
