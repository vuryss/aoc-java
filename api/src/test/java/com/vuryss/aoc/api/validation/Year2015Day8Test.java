...
@QuarkusTest
class Year2015Day8Test extends BaseValidatorTest {
    @Override
    ...
    static Stream<Arguments> invalidInputData() {
        return Stream.of(
            ...
            Arguments.of("\t"),
            Arguments.of("\n"),
            Arguments.of("abc"), // Not quoted
            Arguments.of("\""), // Incomplete quote
            Arguments.of("\"abc"), // Missing closing quote
            Arguments.of("abc\""), // Missing opening quote
            Arguments.of("\"ABC\""), // Uppercase not allowed
            Arguments.of("\"ab c\""), // Space not allowed
            Arguments.of("\"ab-c\""), // Dash not allowed
